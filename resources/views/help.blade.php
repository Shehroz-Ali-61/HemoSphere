...
<html lang="en">
  <head>
    ...
    <title>Hemosphere - Need Help</title>
    <!-- Bootstrap CSS -->
    <link
  ...
  @section('content')
    ...
    <section class="container py-5">
      ...
      <div class="row g-4">
        ...
        <div class="col-md-6">
          <div class="help-card donor-card animate" style="animation-delay: 0.4s;">
            ...
            <div class="text-center mt-4">
              <a href="{{route('account.donateForm') }}" class="cta-btn">Learn How to Donate</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="help-card patient-card animate" style="animation-delay: 0.5s;">
            ...
            <div class="text-center mt-4">
              <a href="{{ route('account.getBloodPost') }}" class="cta-btn">Find a Donor</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="chatbot animate" style="animation-delay: 0.6s;">
        ...
        <a href="{{ route('account.getBloodPost') }}" target="_blank" class="cta-btn">Chat Now</a>
      </div>
      ...
      <div class="mt-5 animate" style="animation-delay: 0.8s;">
        ...
        <div class="testimonial">
          <div class="row align-items-center">
            ...
            <div class="col-md-4 text-center">
              <img
                src="{{ asset('images/shehroz-removebg-preview.png') }}"
                alt="Shehroz Ali"
        ...
        <div class="testimonial">
          <div class="row align-items-center">
            ...
            <div class="col-md-4 text-center">
              <img
                src="{{ asset('images/bakar-removebg-preview.png') }}"
